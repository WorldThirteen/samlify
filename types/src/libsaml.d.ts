...
export interface LibSamlInterface {
    ...
    verifyMessageSignature: (metadata: any, octetString: string, signature: string | Buffer, verifyAlgorithm?: string) => Promise<boolean>;
...
declare const _default: {
    ...
    */
    constructECXMLSignature(opts: SignatureConstructor): string;
    /**
    ...
    */
    constructMessageSignature(octetString: string, key: string | Buffer, passphrase?: string | undefined, isBase64?: boolean | undefined, signingAlgorithm?: string | undefined): string | Buffer;
    /**
    ...
    */
    verifyMessageSignature(metadata: any, octetString: string, signature: string | Buffer, verifyAlgorithm?: string | undefined): Promise<boolean>;
    /**
