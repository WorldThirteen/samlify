...
declare const algorithms: {
    ...
    digest: {
        ...
        'http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha1': string;
        'http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha256': string;
        'http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384': string;
        'http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512': string;
    };
};
